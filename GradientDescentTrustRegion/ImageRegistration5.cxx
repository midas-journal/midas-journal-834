...
int main( int argc, char *argv[] )
{
  ...
  if( argc > 7 )
    {
    initialStepLength = atof( argv[7] );
    }

  // Software Guide : BeginCodeSnippet
  optimizer1->SetRelaxationFactor( 0.6 );
  optimizer1->SetMaximumStepLength( initialStepLength ); 
  optimizer1->SetMinimumStepLength( 0.001 );
  optimizer1->SetNumberOfIterations( 200 );
  optimizer2->SetInitialStepLength( initialStepLength ); 
