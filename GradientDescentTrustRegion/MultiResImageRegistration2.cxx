...
int main( int argc, char *argv[] )
{
 ...
 bool mode=true;
  ...
  // Note that these changed form the original.  The scales must be meaningful for the 
  // trustregion to be of a meaningful size
  optimizerScales[0] = 1e7; // scale for M11
  optimizerScales[1] = 1e7; // scale for M12
  optimizerScales[2] = 1e7; // scale for M21
  optimizerScales[3] = 1e7; // scale for M22

  optimizerScales[4] = 1.0; // scale for translation on X
  optimizerScales[5] = 1.0; // scale for translation on Y
  // Software Guide : EndCodeSnippet
 ...
 //  Software Guide : BeginLatex
  ...
  optimizer2->SetMaximumStepLength(  16  );
