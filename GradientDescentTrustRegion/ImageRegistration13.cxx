...
int main( int argc, char *argv[] )
{
  ...
  if( argc > 5 )
    ...
    metric->SetUseExplicitPDFDerivatives( atoi( argv[5] ) );
    }
  ...
  if( argc > 6 )
    ...
    // BSplineTransform.
    metric->SetUseCachingOfBSplineWeights( atoi( argv[6] ) );
    }
  ...
  optimizer1->SetMaximumStepLength( 0.5   );
  optimizer1->SetMinimumStepLength( 0.0001 );
  optimizer1->SetNumberOfIterations( 400 );
  optimizer2->SetScales( optimizerScales );

  optimizer2->SetInitialStepLength( 0.5   );
  optimizer2->SetMinimumStepLength( 0.0001 );
  optimizer2->SetNumberOfIterations( 400 );
   // Software Guide : EndCodeSnippet
